...
export class Migration20250121090724 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('CREATE UNIQUE INDEX IF NOT EXISTS "IDX_wishlist_item_id_variant_id_unique" ON "wishlist_item" (id, variant_id) WHERE deleted_at IS NULL;');
